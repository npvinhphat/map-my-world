...
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req,
	...
	twist_command.linear.x = req.linear_x;
	twist_command.angular.z = req.angular_z;

	motor_command_publisher.publish(twist_command);

	res.msg_feedback = "Twist command set - linear_x: " + std::to_string(req.linear_x) + ", angular_z: " + std::to_string(req.angular_z);
